...
<html>
  ...
  <body class="easyui-layout">
    <div data-options="region:'north',href:'${pageContext.request.contextPath}/background/background/north'" style="height: 60px;overflow: hidden;"></div>
	<div data-options="region:'west',title:'功能导航',href:'${pageContext.request.contextPath}/background/background/menu'" style="width: 200px;overflow: hidden;"></div>
	<div data-options="region:'center',title:'欢迎使用本系统',href:'${pageContext.request.contextPath}/background/background/center'" style="overflow: hidden;"></div>
	<div data-options="region:'south',href:'${pageContext.request.contextPath}/background/background/south'" style="height: 25px;overflow: hidden;"></div>
  </body>
</html>
